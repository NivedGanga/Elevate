...
class _$_SplashState implements _SplashState {
  const _$_SplashState({required this.isUserLoggedIn});
  ...
  @override
  String toString() {
    return 'SplashState(isUserLoggedIn: $isUserLoggedIn)';
  }
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({required final bool? isUserLoggedIn}) =
      _$_SplashState;
